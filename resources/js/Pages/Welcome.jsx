    ...
    return (
        <>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 min-h-screen flex flex-col">
                ...
                {/* Hero Section */}
                <section className="flex flex-col items-center justify-center text-center px-6 md:px-12 h-full bg-gradient-to-b from-green-700/20 to-yellow-100/20 dark:from-gray-800/20">
